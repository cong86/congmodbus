"""Status sensor for zhimodbus polling."""
...
def setup_platform(hass, conf, add_devices, discovery_info=None):
    """Set up zhimodbus polling status sensor."""
    if discovery_info:
    ...
    add_devices([ZhiModbusPollingSensor(runtime, name)], True)


class ZhiModbusPollingSensor(SensorEntity):
    ...
    def unique_id(self):
        ...
        return "zhimodbus.polling." + slugify(self._runtime.hub_name)
